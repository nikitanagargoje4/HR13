...
import { Attendance, User, insertAttendanceSchema } from "@shared/schema";
...
export default function AttendancePage() {
  ...
  const adminColumns: ColumnDef<Attendance>[] = [
    {
      accessorKey: "employee",
      header: "Employee",
      cell: ({ row }) => getEmployeeName(row.original.userId),
    },
    {
      accessorKey: "checkInTime",
      header: "Check In",
                ...
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                  ...
                  <div className="xl:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-3xl font-bold">
                          {dateAttendance.filter(a => a.status === 'present').length}
                        </div>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-3xl font-bold">
                          {employees.length - dateAttendance.filter(a => a.status === 'present').length}
                        </div>
                        <p className="text-sm text-slate-500">of {employees.length} employees</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-3xl font-bold">
                          {/* In a real app, you would calculate employees on approved leave */}
                          0
                        </div>
                        <p className="text-sm text-slate-500">of {employees.length} employees</p>
                      </CardContent>
