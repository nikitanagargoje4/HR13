...
export function MultiStepEmployeeForm({ employee, departments, onSuccess }: MultiStepEmployeeFormProps) {
  ...
  return (
    <div className="form-container max-h-[75vh] overflow-y-auto">
      {/* Executive Header */}
      ...
      <Form {...form}>
        ...
        >
          ...
          {/* Form Navigation */}
          <div className="sticky bottom-0 bg-white/95 backdrop-blur-sm border-t-2 border-slate-200 shadow-lg -mx-6 -mb-6 px-6 py-4 rounded-b-xl">
